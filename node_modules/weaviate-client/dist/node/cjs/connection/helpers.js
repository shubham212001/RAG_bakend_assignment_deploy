...
function addWeaviateEmbeddingServiceHeaders(clusterURL, creds, headers) {
  if (!(0, auth_js_1.isApiKey)(creds)) {
    return headers;
  }
  return Object.assign(Object.assign({}, headers), {
    'X-Weaviate-Api-Key': (0, auth_js_1.mapApiKey)(creds).apiKey,
